...
class TestIDCClient(unittest.TestCase):
    ...
    def test_get_viewer_URL_with_series(self):
        ...
        self.assertIn(f"initialSeriesUID={seriesInstanceUID}", viewer_url)
    ...
    def test_get_viewer_URL_ohif_v3_param(self):
        """Test that OHIF v3 uses initialSeriesUID instead of SeriesInstanceUIDs."""
        c = IDCClient()
        seriesInstanceUID = (
            "1.3.6.1.4.1.14519.5.2.1.3671.4754.228015946741563785297552112143"
        )
        ...
        # Should use initialSeriesUID, not SeriesInstanceUIDs
        self.assertIn("initialSeriesUID=", viewer_url)
